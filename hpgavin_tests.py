...
ax1.scatter(t, y1, marker='.', color='green')
ax2.scatter(t, y2, marker='.', color='green')
ax3.scatter(t, y3, marker='.', color='green')
...
y1_best = example_1_model(t, fit1.params[best_1])
y2_best = example_2_model(t, fit2.params[best_2])
y3_best = example_3_model(t, fit3.params[best_3])
y1_worst = example_1_model(t, fit1.params[worst_1])
y2_worst = example_2_model(t, fit2.params[worst_2])
y3_worst = example_3_model(t, fit3.params[worst_3])
...
ax1.plot(t, y1_best[0], label='Best')
ax1.plot(t, y1_worst[0], label='Worst')
ax2.plot(t, y2_best[0], label='Best')
ax2.plot(t, y2_worst[0], label='Worst')
ax3.plot(t, y3_best[0], label='Best')
ax3.plot(t, y3_worst[0], label='Worst')
